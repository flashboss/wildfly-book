...
@Stateful(name = "stateLocalEngine")
@LocalHome(value = Ejb21LocalHome.class)
@Local(value = Ejb21Local.class)
public class StateLocalEngineBean implements Ejb21Local {

	private static final Logger logger = getLogger(StateLocalEngineBean.class.getName());
	private int speed;
