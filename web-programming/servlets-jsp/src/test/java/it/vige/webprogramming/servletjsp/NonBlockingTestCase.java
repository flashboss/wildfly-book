...
public class NonBlockingTestCase {
	...
	public static WebArchive createWebDeployment() {
		...
		war.addPackage(InventoryServlet.class.getPackage());
		...
		war.addAsWebResource(new FileAsset(new File("src/main/webapp/view/nonblocking.jsp")), "view/form.jsp");
	...
	public void testNonBlocking() throws Exception {
		...
		assertEquals("the page result is: ", "/simple-servlet-test/view/nonblocking.jsp",
